        ...
        http
                ...
                .and()
                    .authorizeRequests() // 다음 리퀘스트에 대한 사용권한 체크
                        .antMatchers("/api/auth/signin","/api/auth/signin/**","/api/auth/signup","/api/auth/signup/**","/api/social/**","/api/upload","/api/auth/test/**","/actuator/health").permitAll() // 가입 및 인증 주소는 누구나 접근가능
